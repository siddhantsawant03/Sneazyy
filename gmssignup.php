...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="gmssignup.css">
        <style>
            .error{
                color: red;
            }
        ...
        <div class="con">
            <form name="myform" action="sign_up.php" novalidate >
                ...
                <span ng-show="myform.$submitted || myform.name.$dirty">
                    <span class="error" ng-show="myform.name.$error.pattern">Name cannot be a number</span>
                    <span class="error" ng-show="myform.name.$error.required">Name not valid</span>
                </span><br><br>

                <label>Email</label>
                <input type="text" name="email" ng-model="email" ng-pattern="/^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/" required><br>
                <span ng-show="myform.$submitted || myform.email.$dirty">
                    <span class="error" ng-show="myform.email.$error.pattern">Email is required</span>
                </span><br><br>

                <label>Mobile Number</label>
                <input type="number" name="mno" ng-model="mno" ng-minlength="10" ng-maxlength="10" required><br>
                <span ng-show="myform.$submitted || myform.mno.$dirty">
                    <span class="error" ng-show="myform.mno.$error.required">Mobile Number not valid</span>
                ...
                <span ng-show="myform.$submitted || myform.course.$dirty">
                    <span class="error" ng-show="myform.course.$error.required">Choose Course</span>
                </span> -->
